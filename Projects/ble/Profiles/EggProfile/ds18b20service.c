 ...
 * MACROS
 */
#define DS18B20_ONE_Period    1000 //
/*********************************************************************
 * CONSTANTS
 */

/* Service configuration values */
#define SENSOR_SERVICE_UUID     DS18B20_SERV_UUID
#define SENSOR_DATA_UUID        DS18B20_DATA_UUID
#define SENSOR_CONFIG_UUID      DS18B20_CONF_UUID
#define SENSOR_PERIOD_UUID      DS18B20_PERI_UUID

#define SENSOR_SERVICE          DS18B20_SERVICE
#define SENSOR_DATA_LEN         DS18B20_DATA_LEN

#define SENSOR_DATA_DESCR       "Ds18b20. Data"
#define SENSOR_CONFIG_DESCR     "Ds18b20. Conf."
#define SENSOR_PERIOD_DESCR     "Ds18b20. Period"
 ...
 */
bStatus_t Ds18b20_AddService( uint32 services )
{
 ...
 */
bStatus_t Ds18b20_RegisterAppCBs( sensorCBs_t *appCallbacks )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Ds18b20_SetParameter( uint8 param, uint8 len, void *value )
{
 ...
 * @return  bStatus_t
 */
bStatus_t Ds18b20_GetParameter( uint8 param, void *value )
{
  bStatus_t ret = SUCCESS;
