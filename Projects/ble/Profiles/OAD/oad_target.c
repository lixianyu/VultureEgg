...
// It is recommended to use a numbering scheme such as all odd(1) numbered versions are
// built to download and run in-place in the Image-B area while all even(2) numbered
// versions are built to download and run in-place in the Image-A area.
